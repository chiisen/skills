...
KIRO_SKILLS_DIR="/Users/liao-eli/.kiro/skills"
...
run_update() {
    ...
    log "  Kiro: $([ $KIRO_RESULT -eq 0 ] && echo '成功' || echo '失敗')"

    # 如果有任何一個失敗，返回非零狀態碼
    if [ $GEMINI_RESULT -ne 0 ] || [ $CODEX_RESULT -ne 0 ] || [ $OPENCODE_RESULT -ne 0 ] || [ $CLAUDE_RESULT -ne 0 ] || [ $WINDSURF_RESULT -ne 0 ] || [ $CURSOR_RESULT -ne 0 ] || [ $QWEN_RESULT -ne 0 ] || [ $KIRO_RESULT -ne 0 ]; then
        return 1
    else
        return 0
    fi
